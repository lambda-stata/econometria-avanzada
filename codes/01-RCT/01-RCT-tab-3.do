...
***	1.1 Load dataset
	use "${data_rct}/Burde and Linden 2013.dta", clear
...
*** 1.5 Exportar a excel
	...
	iebaltab ${panela} ${panelb} ${panelc},	///
		grpvar(treatment) order (1 0)         ///
		rowvarlabels 						              ///
		save("${outputs_rct}/tablas/tab_3_bal_tab.xlsx") replace
	...
	esttab `regs' using "${outputs_rct}/tablas/tab_3.csv", se replace
